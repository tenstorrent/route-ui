...
constexpr SfpuOp SFPU_KERNEL_TYPE = SfpuOp::Reciprocal;
// We define SFPU_KERNEL_TYPE_DEFINED so we don't use SFPU_KERNEL_TYPE from eltwise_unary_sfpu.h
#define SFPU_KERNEL_TYPE_DEFINED
